...
\begin{document}
	...
	\pgfsetlayers{background,main}
		...
		\node (scintillatorcristal) [component, below=of sample] {Scintillator Cristal};
		...
		\node (trigger) [component, below=of discriminator, xshift=4cm] {Acquisition};

		\node (cpu) [component, below=of peakssurement, xshift=4cm] {Acquisition\\ (STM8S003F3P6TR)};
		...
		\draw [-{Latex[scale=3.0]}] (sample) -- node[anchor=west, minimum width=.25cm, draw=none] {gamma ray = high energy, low wavelength single photon} (scintillatorcristal);
		\draw [-{Latex[scale=3.0]}] (scintillatorcristal) -- node[anchor=west, minimum width=.25cm, draw=none] {many photons in visible spectrum = lower energy, lower wavelength} (photomultiplier);
		\draw [-{Latex[scale=3.0]}] (hwpower) -- node[anchor=south, minimum width=.25cm, draw=none] {} (photomultiplier);
		\draw [-{Latex[scale=3.0]}] (photomultiplier) -- node[anchor=west, minimum height=.25cm, draw=none] {current, amount of electrons = photons * tube gain} (amplifier);
		...
		\draw [-{Latex[scale=3.0]}] (uartconverter) -- node[anchor=south, minimum height=.25cm, draw=none] {USB} (pi);
