...
## 2.6 Total Input-Referred RMS Noise

The **total input-referred RMS noise** is the equivalent noise of the analog front-end expressed at the detector input, integrated over the defined system bandwidth.
...
This quantity represents the complete integrated noise contribution of the analog front-end referred to the detector domain (current or charge).

Why This Metric Is Important
* **Direct Comparison:** It allows direct comparison between detector signal magnitude and electronic noise.
* **Sensitivity:** It defines the minimum detectable signal.
* **Charge Analysis:** It determines the **Equivalent Noise Charge (ENC)**.
* **Spectroscopy:** It directly impacts spectroscopy energy resolution (FWHM).
* **Architecture Benchmarking:** It enables fair comparison between different front-end architectures.
