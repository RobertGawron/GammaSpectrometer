...
* [Signal Processing and Sampling Theory](./SignalProcessingAndSampling.md)
  - Bandwidth vs rise time relationship:
    $$t_r \approx \frac{0.35}{f_{3dB}}$$
  - Sampling constraints and discrete-time representation
  - Rule of Three for amplitude reconstruction
  - Samples per pulse:
    $$N_{pulse} = \frac{5\tau}{T_s}$$
  - Digital integration SNR improvement:
    $$SNR \propto \sqrt{N}$$
  - Oversampling ratio:
